...
Shader "ErbGameArt/WorldPotion" {
    Properties {
        ...
        _Wavessize ("Waves size", Range(1, 40)) = 20
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 node_2391 = (i.uv0+(_Speedofbubbles*node_4935.g)*float2(0,-1));
                ...
                float3 emissive = (((_MainTex_var.rgb+((_Mask_var.rgb*_Maskpower)*_Emissivepower*_Maskcolor.rgb*saturate((sin(((_Wavesspeed*node_4935.g)+(_NumberofWaves*i.uv0.r)))+(1.0 - ((pow(i.uv0.g,(1.0 - i.posWorld.g))*2.0+-1.0)*_Wavessize))))*pow(_PotionBubbles_var.rgb,_Powerofbubbles)))*_Color.rgb*i.vertexColor.rgb*_Opacitypower)*node_603);
